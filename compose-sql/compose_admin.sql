/*
 ...
 Source Schema         : compose_admin

 Target Server Type    : MySQL
 Target Server Version : 80016
 File Encoding         : 65001

 Date: 16/11/2021 14:12:33
*/
...
CREATE TABLE `account` (
  ...
  `user_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '用户userId',
  `money` bigint(11) DEFAULT NULL COMMENT '余额，单位分',
...
-- ----------------------------
BEGIN;
INSERT INTO `account` VALUES (1, 'abc123', 600, '2021-10-19 17:49:53');
COMMIT;
...
INSERT INTO `prov_order` VALUES (29, '478975846347400192', '53256102816645120', 1, 1, 0, 1.01, NULL, 5, 'https://page-4gttfzlfpj4.zhifu.fm.it88168.com/pay?orderNo=53256102816645120', NULL, 1.01, NULL, '2021-11-12 17:19:01', NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `undo_log` VALUES (18213203278835901, '192.168.32.2:8091:18213203278835896', 'serializer=kryo', 0x2D01000000, 1, '2021-11-15 05:42:06.300673', '2021-11-15 05:42:06.300673');
COMMIT;
